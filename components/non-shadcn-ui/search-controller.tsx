...
export default function SearchController({
    ...
    async function handleSearch() {
        ...
        //we only want vinyl records in our search results, TODO: maybe later we can let users choose other formats like CD or cassette
        searchPayload.format = "vinyl";

        try {
            const searchResults: SearchResults =
                await searchDiscogs(searchPayload);
            searchResults &&
    ...
    return (
        <div className="w-full max-w-4xl flex flex-col gap-4">
            ...
            <NativeSelect ref={countrySelectRef}>
                ...
                <NativeSelectOption value="worldwide">
                    Worldwide
                </NativeSelectOption>
